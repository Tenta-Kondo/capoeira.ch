@extends("layout") @section("content")<main>
    ...
    <div class="nav-link"><a href="/top">
            <p>掲示板へ行く</p>
        </a></div>@if(!$user->status)<div class="nav-link"> <a href="/user-page">
            <p>有料会員登録はこちら</p>
        </a></div>@endif @if($user->status === 1)<div class="nav-link"> <a href="/user/paidpage"></a>
        <p>有料会員限定ページはこちら
    </div>@endif<div class="nav-link">
        <p>coming soon
    </div>
