                ...
                <div class="card mb-4">
                        ...
                        <div v-else-if="isSubscribed">
                            ...
                            <div v-else>
                                ...
                                <button class="btn" type="button" @click="cancel">キャンセル</button>
                                <hr>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn" type="button" @click="changePlan">プランを変更する</button>
                                </div>
                                <hr>
                                <div class="form-group">
    ...
    <script>
        new Vue({
            ...
            data: {
                ...
                plan: '',
                planOptions: {
                    !!json_encode(config('services.stripe.plans')) !!
                }
            },
            methods: {
                async subscribe(e) {
